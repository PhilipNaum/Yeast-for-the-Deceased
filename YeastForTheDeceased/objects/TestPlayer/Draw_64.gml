...
if (parry)
{
	...
	draw_sprite_ext(spr_scythe_effect, image_index, x, y,(size+40)/sprite_get_width(spr_scythe_effect),(size+40)/sprite_get_height(spr_scythe_effect),0,c_white,100);
}